...
<div id="broadcast-post">
  <el-breadcrumb separator=">" class="zike-breadcrumb">
    ...
    <el-breadcrumb-item>{{$route.name === 'broadcastPost' ? '创建直播' : '编辑直播'}}</el-breadcrumb-item>
  </el-breadcrumb>
  <el-form
    :model="form"
    :rules="rules"
          ...
          <div class="menber-compulsory-type-list" v-if="models.currentModalName === 'memberList'">
            ...
            <div class="menber-list limit-menber-height">
              <div
                ...
                :key="menberIndex"
                @click="multipleSelection('memberList', menberItem, menberIndex)"
          ...
          <div class="menber-compulsory-type-list" v-if="models.currentModalName === 'invisibleList'">
            ...
            <div class="menber-list limit-menber-height">
              <div
                v-for="(menberItem, menberIndex) in menberLists"
                :key="menberIndex"
                @click="multipleSelection('invisibleList', menberItem, menberIndex)"
                :class="{'common-checkbox-active': menberItem.active}"
                class="common-checkbox">
                <i class="icon iconfont icon-check-circle" v-show="menberItem.active"></i>
                <i class="icon iconfont icon-radio_default" v-show="!menberItem.active"></i>
