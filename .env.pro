...
VUE_APP__LOGIN_OUT_URL = 'https://admin-api.xplus.xiaodengta.com/unifyauth/logout'
VUE_APP__COOKIE_DOMAIN = 'xplus.xiaodengta.com'
VUE_APP__WEBSOKET_API = 'ws://work-api.xplus.xiaodengta.com'